...
handler.all = async function (m) {
   ...
   global.pu = pp
	...
	global.kontak2 = [
	[owner[0], await conn.getName(owner[0] + '6282351108031@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'RyeonDev@gmail.com', true],
	[owner[1], await conn.getName(owner[1] + '@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'RyeonDev@gmail.com', true], ]
